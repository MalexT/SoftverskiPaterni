...
public class FormMain extends javax.swing.JDialog implements DocumentListener {
    ...
    private int amount20 = 150;
    private int amount50 = 50;
    private int amount100 = 100;
    ...
    private void initComponents() {
        ...
        txt100amount = new javax.swing.JTextField();
        txt50amount = new javax.swing.JTextField();
        txt20amount = new javax.swing.JTextField();
        txt1amount = new javax.swing.JTextField();
        ...
        txt100amount.setEditable(false);

        txt50amount.setEditable(false);

        txt20amount.setEditable(false);

        txt1amount.setEditable(false);
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(txt100amount, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(txt50amount, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(txt20amount, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(txt1amount, javax.swing.GroupLayout.Alignment.LEADING)))
                .addContainerGap())
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jrb20)
                            .addComponent(txt100amount, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel8))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jrb25)
                            .addComponent(txt50amount, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel9))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jrb30))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txt20amount, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel10)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jrb50))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txt1amount, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel11)))
    ...
    private void btnMakeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMakeActionPerformed
        try {
            ...
            map.put("20", 0);
            map.put("1", 0);
            Currency currency = new Currency(Integer.parseInt(txtReturns.getText()));
            node.getCurrency(currency, map);
            if (amount100 < map.get("100")) {
                throw new Exception("Nema dovoljno novca u kasi.");
            }
            if (amount50 < map.get("50")) {
                throw new Exception("Nema dovoljno novca u kasi.");
            }
            if (amount20 < map.get("20")) {
                throw new Exception("Nema dovoljno novca u kasi.");
            }
            if (amount1 < map.get("1")) {
                throw new Exception("Nema dovoljno novca u kasi.");
            }
            
            txt1.setText(map.get("1").toString());
            txt20.setText(map.get("20").toString());
            txt50.setText(map.get("50").toString());
            txt100.setText(map.get("100").toString());
            amount1 -= map.get("1");
            amount20 -= map.get("20");
            amount50 -= map.get("50");
            amount100 -= map.get("100");
            txt100amount.setText(String.valueOf(amount100));
            txt50amount.setText(String.valueOf(amount50));
            txt20amount.setText(String.valueOf(amount20));
            txt1amount.setText(String.valueOf(amount1));

            if (amount100 < 40) {
                JOptionPane.showMessageDialog(this, "Imate "+amount100+" novcanica od po 100 dinara");
            }
            if (amount50 < 20) {
                JOptionPane.showMessageDialog(this, "Imate "+amount50+" novcanica od po 50 dinara");
            }
            if (amount20 < 30) {
                JOptionPane.showMessageDialog(this, "Imate "+amount20+" novcanica od po 20 dinara");
            }
            if (amount1 < 40) {
                JOptionPane.showMessageDialog(this, "Imate "+amount1+" novcanica od po 1 dinara");
            }
    ...
    private javax.swing.JTextField txt100amount;
    private javax.swing.JTextField txt1amount;
    private javax.swing.JTextField txt20;
    private javax.swing.JTextField txt20amount;
    private javax.swing.JTextField txt50;
    private javax.swing.JTextField txt50amount;
